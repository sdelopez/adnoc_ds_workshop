# Challenge 2 : US Oil and Gas Production
...
cd Documents/GitHub/ml-week-challenges/01-Data-Science-Toolkit/02-US-Oil-and-Gas-Production
```
...
Your browser should _automatically_ open Jupyter. You should see the exercise folder with `data`, `README.md`, etc. Click on the `02-US-Oil-and-Gas-Production.ipynb` link to open the notebook. This is where you will write notes & Python code.
...
Today, we will do things in this notebook:
...
Try to re-use the shortcuts and notebook features you have just seen in Notebook-101.
...
Remember the steps you saw this morning in lecture to save the code on GitHub? Let's do it again, for this new exercise:

1. Open GitHub Desktop
1. It should automatically detect that the `02-US-Oil-and-Gas-Production.ipynb` file has changed. If not, ask a TA
